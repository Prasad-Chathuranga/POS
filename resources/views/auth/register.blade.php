...
<form class="splash-container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <input id="mobile" type="number" placeholder="Mobile" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" required autocomplete="mobile">
        ...
        <div class="card-footer bg-white">
            <p>Already an user ? <a href="{{route('login')}}" class="text-secondary">Login Here.</a></p>
        </div>
    </div>
</form>
